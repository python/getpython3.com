...
<p>Python 3 is
the future of the Python language, and <a href="http://www.python.org/psf/">the Python
Software Foundation</a> (PSF) strongly believes in supporting the porting effort.
</p>

<p>For example, the PSF issued developer grants to port
...
It has also provided grants for other general Python development work, such as to
<a href="https://plus.google.com/115362263245161504841/posts/MSaYR7SDKSg">Brett Cannon</a>
for completely rewriting the
...
community, its efforts, its developers, designers and people.</p>
