    ...
    <div class="span12">
        ...
        <div class="row">
            ...
            <div class="span6">
                ...
                <ul>
                    ...
                    <li><a href="http://ptgmedia.pearsoncmg.com/imprint_downloads/informit/promotions/python/python2python3.pdf">Moving from Python 2 to Python 3 (pdf)</a></li>
                    ...
                    <li><a href="http://wiki.python.org/moin/Python2orPython3">Python2orPython3</a></li>
                </ul>
            </div>
            <div class="span6">
        ...
        <div class="row">
            ...
            <div class="span6">
                <h3>Port Counting</h3>
                <ul>
                    <li><a href="http://pypi.python.org/pypi?:action=browse&c=533&show=all">PyPI Search - Python 3 Classifier</a> </li>
                    <li><a href="http://dev.pocoo.org/~gbrandl/py3pkgs.png">Handy Chart</a></li>
                </ul>
                <h3>Port Voting</h3>
                <ul>
                    <li><a href="http://www.python.org/3kpoll">Python.org Py3k voting results</a></li>
                </ul>
            </div>
        </div>
    </div>
